...
const Hero = ({blur}) => {
  ...
  return (
    <div id='s1' className="max-w-[1640px] mx-auto px-2 mt-5 bg-[#f4f6f5] ">
      <div className='flex flex-row flex-wrap items-center justify-around py-[30px] '>
        ...
        <div data-aos="fade-right" className='flex flex-col gap-y-5'>
          ...
          <div className='flex flex-row gap-2 items-center'>
            ...
            <button className="bg-black text-white py-3 px-4 text-[20px] text-center">Shop now</button>
          </div>
        </div>
        {/* right */}
        <div data-aos="fade-left" className='mt-10'>
          <img src={bannerImg} alt="" className={`w-full max-h-[800px] object-cover ${blur?"blur-md":""} duration-200`} />
        </div>
      </div>
